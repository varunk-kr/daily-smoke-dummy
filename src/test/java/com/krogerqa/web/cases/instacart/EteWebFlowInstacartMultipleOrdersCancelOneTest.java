...
/**
 * Scenario FFILLSVCS-TC-12862 Web Flows -
 ...
 */
public class EteWebFlowInstacartMultipleOrdersCancelOneTest extends BaseTest {
    ...
    @Test(groups = {"ete_instacart_tc_12862_web_part1_nonEbt", "ete_web_part1_nonEbt", "ete_web_part1_singleThreaded"}, description = "Verify new order placed for instacart order")
    public void validateE2eMultipleOrdersCancelOneInstacartOrder() {
        firstOrderTestData = ExcelUtils.getTestDataMap(ExcelUtils.INSTACART_SCENARIO_TC_12862, ExcelUtils.SHEET_NAME_TEST_DATA);
        ...
        secondOrderTestData = ExcelUtils.getTestDataMap(ExcelUtils.INSTACART_SCENARIO_TC_12862_1, ExcelUtils.SHEET_NAME_TEST_DATA);
    ...
    @Test(groups = {"ete_instacart_tc_12862_web_part2_nonEbt", "ete_web_part2_nonEbt", "ete_web_part2_singleThreaded"}, description = "Verify order staged for instacart order")
    public void validateE2eStagedMultipleOrdersCancelOneInstacartOrder() {
    ...
    @Test(groups = {"ete_instacart_tc_12862_web_part3_nonEbt", "ete_web_part3_nonEbt", "ete_web_part3_singleThreaded"}, description = "Verify order picked up and paid for instacart order")
    public void validateE2ePickedUpAndPaidMultipleOrdersCancelOneInstacartOrder() {
        firstOrderTestData = ExcelUtils.getTestDataMap(ExcelUtils.INSTACART_SCENARIO_TC_12862, ExcelUtils.INSTACART_SCENARIO_TC_12862);
        loginWeb.loginCue(firstOrderTestData.get(ExcelUtils.STORE_ID), firstOrderTestData.get(ExcelUtils.STORE_BANNER));
        cueOrderValidation.verifyPickedUpAndPaidForInstacartOrder(firstOrderTestData);
        baseCommands.openNewUrl(PropertyUtils.getCueUrl(secondOrderTestData.get(ExcelUtils.STORE_ID)));
        cueOrderValidation.verifyCancelledStatusForInstacartOrder(secondOrderTestData);
    }
}