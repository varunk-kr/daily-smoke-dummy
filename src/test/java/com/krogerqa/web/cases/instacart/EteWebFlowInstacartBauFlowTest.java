...
/**
 * Scenario FFILLSVCS-TC-12962 Web Flows -
 ...
 */
public class EteWebFlowInstacartBauFlowTest extends BaseTest {
    static HashMap<String, String> testOutputData = new HashMap<>();
    CueOrderValidation cueOrderValidation = CueOrderValidation.getInstance();
    InstacartHelper instacartHelper = InstacartHelper.getInstance();
    LoginWeb loginWeb = LoginWeb.getInstance();

    @Test(groups = {"ete_instacart_tc_12962_web_part1_nonEbt", "ete_web_part1_nonEbt", "ete_web_part1_singleThreaded"}, description = "Verify new order placed for instacart order")
    public void validateE2eNewInstacartOrder() {
        testOutputData = ExcelUtils.getTestDataMap(ExcelUtils.INSTACART_SCENARIO_TC_12962, ExcelUtils.SHEET_NAME_TEST_DATA);
    ...
    @Test(groups = {"ete_instacart_tc_12962_web_part2_nonEbt", "ete_web_part2_nonEbt", "ete_web_part2_singleThreaded"}, description = "Verify order staged for instacart order")
    ...
    @Test(groups = {"ete_instacart_tc_12962_web_part3_nonEbt", "ete_web_part3_nonEbt", "ete_web_part3_singleThreaded"}, description = "Verify order picked up and paid for instacart order")
