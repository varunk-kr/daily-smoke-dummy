 ...
 */
public class EteWebFlowMoveItemsPreWeighedScreenTest extends BaseTest {
    ...
    public void validateE2eNewNonEbtPclItemMovementViaPreWeighedOrder() {
        ...
        testOutputData = krogerSeamLessPortalOrderCreation.verifyNewOrderCreation(ExcelUtils.PCL_SCENARIO_PREWEIGHED_TC_4504);
        loginWeb.loginCue(testOutputData.get(ExcelUtils.STORE_ID), testOutputData.get(ExcelUtils.STORE_BANNER));
        testOutputData = cueOrderValidation.verifyOrderInCue(ExcelUtils.PCL_SCENARIO_PREWEIGHED_TC_4504, testOutputData);
    }
    ...
    public void validateE2eNonEbtPclItemMovementViaPreWeighedOrderPicked() {
        testOutputData = ExcelUtils.getTestDataMap(ExcelUtils.PCL_SCENARIO_PREWEIGHED_TC_4504, ExcelUtils.PCL_SCENARIO_PREWEIGHED_TC_4504);
        loginWeb.loginCue(testOutputData.get(ExcelUtils.STORE_ID), testOutputData.get(ExcelUtils.STORE_BANNER));
        cueOrderValidation.verifyPclPickedStatusInCue(ExcelUtils.PCL_SCENARIO_PREWEIGHED_TC_4504, testOutputData);
    }
    ...
    public void validateE2eNonEbtPclItemMovementViaPreWeighedOrderPaid() {
        ...
        loginWeb.loginCue(testOutputData.get(ExcelUtils.STORE_ID), testOutputData.get(ExcelUtils.STORE_BANNER));
        cueOrderValidation.verifyPickedUpAndPaid(ExcelUtils.PCL_SCENARIO_PREWEIGHED_TC_4504);
    }
}
