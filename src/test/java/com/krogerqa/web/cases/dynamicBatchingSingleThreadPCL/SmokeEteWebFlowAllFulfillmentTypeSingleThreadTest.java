...
/**
 * Scenario FFILLSVCS-TC-12730 Web Flows -
 ...
 */
public class SmokeEteWebFlowAllFulfillmentTypeSingleThreadTest extends BaseTest {
    ...
    public void validatePclFulfillmentTypesSmokeSingleOrderTestOrderPlaced() {
        ...
        testOutputData = krogerSeamLessPortalOrderCreation.verifyNewOrderCreation(ExcelUtils.DB_SINGLE_THREAD_12730);
        testOutputData.put(ExcelUtils.IS_DB_PCL_SINGLE_THREAD, String.valueOf(true));
        testOutputData.put(ExcelUtils.IS_DYNAMIC_BATCHING, String.valueOf(true));
        loginWeb.loginCue(testOutputData.get(ExcelUtils.STORE_ID), testOutputData.get(ExcelUtils.STORE_BANNER));
        testOutputData = cueOrderValidation.verifyOrderInCue(ExcelUtils.DB_SINGLE_THREAD_12730, testOutputData);
    }
    ...
    public void validatePclFulfillmentTypesSmokeSingleOrderTestOrderPicked() {
        ...
        loginWeb.loginCue(testOutputData.get(ExcelUtils.STORE_ID), testOutputData.get(ExcelUtils.STORE_BANNER));
        cueOrderValidation.verifyPclPickedStatusInCue(ExcelUtils.DB_SINGLE_THREAD_12730, testOutputData);
        cueOrderValidation.updatePclMapsAfterPicking(ExcelUtils.DB_SINGLE_THREAD_12730, testOutputData);
    }
    ...
    public void validatePclFulfillmentTypesSmokeSingleOrderTestOrderStaging() {
        testOutputData = ExcelUtils.getTestDataMap(ExcelUtils.DB_SINGLE_THREAD_12730, ExcelUtils.DB_SINGLE_THREAD_12730);
        loginWeb.loginCue(testOutputData.get(ExcelUtils.STORE_ID), testOutputData.get(ExcelUtils.STORE_BANNER));
        cueOrderValidation.verifyStagingStatusInCue(testOutputData);
    }

    @Test(groups = {"ete_singleThread_pcl_tc_fulfillment_smokeTest_SingleThread_web_part4_nonEbt", "ete_web_part3_nonEbt", "ete_web_part3_singleThreaded"}, description = "Verify order staged and checked-in for various fulfillment types for Non-EBT pcl Single Thread order")
    public void validatePclFulfillmentTypesSmokeSingleOrderTestOrderStaged() {
        testOutputData = ExcelUtils.getTestDataMap(ExcelUtils.DB_SINGLE_THREAD_12730, ExcelUtils.DB_SINGLE_THREAD_12730);
        loginWeb.loginCue(testOutputData.get(ExcelUtils.STORE_ID), testOutputData.get(ExcelUtils.STORE_BANNER));
        List<HashMap<String, String>> itemData = ExcelUtils.getItemUpcData(ExcelUtils.DB_SINGLE_THREAD_12730);
        ...
        ExcelUtils.writeToExcel(ExcelUtils.DB_SINGLE_THREAD_12730, testOutputData);
        cueOrderValidation.verifyStagedPclStatusInCue(testOutputData);
    }

    @Test(groups = {"ete_singleThread_pcl_tc_fulfillment_smokeTest_SingleThread_web_part5_nonEbt", "ete_web_part4_nonEbt", "ete_web_part4_singleThreaded"}, description = "Verify E2E non ebt order for various fulfillment types for DyB PCL Single Thread Bulk Staging order (Picking and Staging Using Harvester Native app)")
    public void validatePclFulfillmentTypesSmokeTestSingleThreadOrderPaid() {
        testOutputData = ExcelUtils.getTestDataMap(ExcelUtils.DB_SINGLE_THREAD_12730, ExcelUtils.DB_SINGLE_THREAD_12730);
        cueOrderValidation.verifyOrderDroppedFromDash(testOutputData);
        loginWeb.loginCue(testOutputData.get(ExcelUtils.STORE_ID), testOutputData.get(ExcelUtils.STORE_BANNER));
        cueOrderValidation.verifyPickedUpAndPaid(ExcelUtils.DB_SINGLE_THREAD_12730);
    }
}
