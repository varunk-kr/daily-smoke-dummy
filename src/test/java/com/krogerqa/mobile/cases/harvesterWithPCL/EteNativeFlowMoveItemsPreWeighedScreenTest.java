 ...
 */
public class EteNativeFlowMoveItemsPreWeighedScreenTest extends BaseTest {
    ...
    public void validateE2eNonEbtPclItemMovementViaPreWeighedOrderSelecting() {
        ...
        testOutputData = harvesterSelectingAndStaging.verifyHarvesterSelectingPcl(ExcelUtils.PCL_SCENARIO_PREWEIGHED_TC_4504, testOutputData);
    }
    ...
    public void validateE2eNonEbtPclItemMovementViaPreWeighedOrderStaging() {
        testOutputData=ExcelUtils.getTestDataMap(ExcelUtils.PCL_SCENARIO_PREWEIGHED_TC_4504,ExcelUtils.PCL_SCENARIO_PREWEIGHED_TC_4504);
        loginUsingOktaSignIn(PropertyUtils.getHarvesterNativeUsername(), PropertyUtils.getHarvesterNativePassword());
        harvesterSelectingAndStaging.verifyHarvesterStagingPcl(ExcelUtils.PCL_SCENARIO_PREWEIGHED_TC_4504, testOutputData);
    }
    ...
    public void validateE2eNonEbtPclItemMovementViaPreWeighedOrderCheckout() {
        ...
        ciaoDestagingAndCheckout.verifyOrderCheckoutInCiao(ExcelUtils.PCL_SCENARIO_PREWEIGHED_TC_4504, testOutputData);
    }
